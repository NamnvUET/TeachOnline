            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Modify Lesson {{$lesson->title}}</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <!-- notification -->
                        ...
                        <form action="{{ url('manageClass/'.$class->id.'/'.$class->name_without_sign.'/modifyLesson/'.$lesson->id) }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                            {{csrf_field()}}
