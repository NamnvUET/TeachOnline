            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">List Comment of {{$lesson->title}} - {{$lesson->classes->name}}</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <!-- notification -->
                        ...
                        <table id="list_comment" class="table table-bordered table-striped">
                            ...
                            @foreach($comments as $comment)
                                <tr>
                                    ...
                                    @if(isset($duyet))
                                        <td class="text-center"><a href="{{url('manageClass/'.$class->id.'/'.$class->name_without_sign.'/'.$lesson->id.'/'.$comment->id.'/chophep')}}"><button class="btn btn-success"><span class="fa fa-check "></span></button></a></td>
                                    @else
                                        <td class="text-center"><a href="{{url('manageClass/'.$class->id.'/'.$class->name_without_sign.'/'.$lesson->id.'/deleleComment/'.$comment->id)}}"><button class="btn btn-warning"><span class="fa fa-trash "></span></button></a></td>
                                    @endif
                                </tr>
                            @endforeach
                            </tbody>
